...
function MainPage() {
  ...
  const loadData = async () => {
    try {
      ...
      try {
        console.log('[MAIN PAGE] Trying enhanced dashboard API...')
        ...
        console.log('[MAIN PAGE] Enhanced API failed, using fallback:', enhancedError.message)
      }
  ...
  const handleCompletionCreated = async (completionData) => {
    ...
    try {
      ...
      console.log('[MAIN PAGE] Completion created with enhanced API')
  ...
  const handleCompletionDeleted = async (habitId, timeOfDay) => {
    ...
    try {
      ...
      console.log('[MAIN PAGE] Completion deleted with enhanced API')
      return true
    } catch (error) {
  ...
  // Handle base camp object clicks
  const handleBaseCampClick = (section) => {
    setCurrentSection(section)
  ...
  return (
    <div className="min-h-screen bg-theme-bg">
      ...
      {/* Robot Base Camp Section */}
      <section className="min-h-screen">
        <RobotBaseCamp onObjectClick={handleBaseCampClick} />
      </section>
